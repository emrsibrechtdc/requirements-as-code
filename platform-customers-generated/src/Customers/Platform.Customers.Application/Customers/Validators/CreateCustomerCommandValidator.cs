...
using Platform.Customers.Domain;
...
public class CreateCustomerCommandValidator : AbstractValidator<CreateCustomerCommand>
{
    public CreateCustomerCommandValidator()
    {
        ...
        RuleFor(x => x.CustomerType).NotEmpty().NotNull().MaximumLength(20)
            .Must(BeValidCustomerType)
            .WithMessage("Customer type must be one of: ENTERPRISE, SMALL_BUSINESS, RETAIL, INDIVIDUAL");
    ...
    {
        var validTypes = new[] { 
            CustomersConstants.CustomerTypes.ENTERPRISE,
            CustomersConstants.CustomerTypes.SMALL_BUSINESS,
            CustomersConstants.CustomerTypes.RETAIL,
            CustomersConstants.CustomerTypes.INDIVIDUAL
        };
